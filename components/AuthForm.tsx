  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2 w-full rounded-full bg-amber-500 px-6 py-3 text-body-medium text-light-100 hover:bg-dark-700 focus:outline-none focus:ring-2 focus:ring-dark-900/20"
        >
